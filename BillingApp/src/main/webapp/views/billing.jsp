...
<html>
    ...
    <body>
        ...
        <table style="width: 100%;
            ...
            <tr>
                <td  style="color:green;" colspan="3">Total</td>
                <td style="color:green;" id="getTotal">Initial cost is ${initial_total_cost} INR</td>
                <td style="color:green;" id="getVat">${initial_gst}</td>
                <td style="color:green;" id="grandTotal">Total Cost is ${initial_grand_total} INR</td>
            </tr>
        </table>
    </body>
    <script>
